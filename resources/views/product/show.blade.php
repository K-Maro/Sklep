...
<h1 class="text-center mt-2">{{ $product->title }} | Szczegóły</h1>
<hr>
<br>
...
<div class="container">
    <div class="row">
        <div class="col-md-9" style="display:flex">
            ...
            <div class="container m-2 p-2">
                ...
                <div class="container m-2 p-2">
                  ...
                  <a href="{{ route('product.index') }}" class="btn btn-success">Strona Główna</a>
                  <a href="{{ route('product.edit', $product->id) }}" class="btn btn-primary">Edycja</a>
                </div>
              </div>
        ...
        <div class="col-md-3">
            ...
            <div class="comments p-2 m-2" style="background-color: #1ba942 ">
           ...
           <div class="container m-2 p-2">
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="comment" id="comment" placeholder="Wpisz swój komentarz">
                </div>

                <div class="mb-3">
                    <label for="rating" class="form-label">Ocena</label>
                    <input type="number" class="form-control" name="rating" id="rating" placeholder="Wstaw Rating">
                </div>

                  <button type="submit" id="addCommentBtn" class="btn btn-success">Prześlij</button>
